...
public class Board {
	...
	public Board() {
		...
		space = space_factory.getPropertySpace("Street", "States Avenue", 140, new int[] { 10, 50, 150, 450, 625, 750 },
				"Pink");
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getPropertySpace("Street", "Virginia Avenue", 160,
				new int[] { 12, 60, 180, 500, 700, 900 }, "Pink");
		this.addToNeighborhood(space);
		spaces.add(space);
		spaces.add(space_factory.getPropertySpace("Railroad", "Pennsylvania Railroad", 200, new int[] {}, ""));
		space = space_factory.getPropertySpace("Street", "St. James Place", 180,
		...
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getPropertySpace("Street", "New York Avenue", 200,
		...
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getPropertySpace("Street", "Illinois Avenue", 240,
				new int[] { 20, 100, 300, 750, 925, 1100 }, "Red");
		this.addToNeighborhood(space);
		spaces.add(space);
		spaces.add(space_factory.getPropertySpace("Railroad", "B. & O. Railroad", 200, new int[] {}, ""));
		space = space_factory.getPropertySpace("Street", "Atlantic Avenue", 260,
				new int[] { 22, 110, 330, 800, 975, 1150 }, "Yellow");
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getPropertySpace("Street", "Ventnor Avenue", 260,
				new int[] { 22, 110, 330, 800, 975, 1150 }, "Yellow");
		this.addToNeighborhood(space);
		spaces.add(space);
		spaces.add(space_factory.getPropertySpace("Utility", "Water Works", 150, new int[] {}, ""));
		space = space_factory.getPropertySpace("Street", "Marvin Gardens", 280,
		...
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getPropertySpace("Street", "North Carolina Avenue", 300,
				new int[] { 26, 130, 390, 900, 1100, 1275 }, "Green");
		this.addToNeighborhood(space);
		spaces.add(space);
		space = space_factory.getBoardSpace("Open");
		...
		space = space_factory.getPropertySpace("Street", "Boardwalk", 400, new int[] { 50, 200, 600, 1400, 1700, 2000 },
				"Blue");
		this.addToNeighborhood(space);
		spaces.add(space);
	}
