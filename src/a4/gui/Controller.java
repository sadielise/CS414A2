...
public class Controller {
	...
	public void createLandedOnUnownedDialog(String property, int cost) {
		int choice = JOptionPane.showConfirmDialog(view,
				"Would you like to purchase " + property + " for $" + cost + "?", "Purchase dialog",
	...
	public void createStartJailTurnDialog(String player) {
		int choice = JOptionPane.showConfirmDialog(view,
				"It is " + player
						+ "'s turn, but you are in jail! Do you want to pay the fine? If not, the system will roll for you.",
				"In Jail Dialog", JOptionPane.YES_NO_OPTION);
		if (choice == JOptionPane.YES_OPTION) {
	...
	public void createUnableToPurchasePropertyDialog(String player, String property) {
		JOptionPane.showMessageDialog(view,
				player + " was unable to purchase " + property + " so it will be auctioned.");
		createAuctionDialog(property);
	}
	...
	public void createSucceededInLeavingJailDialog() {
		JOptionPane.showMessageDialog(view,
				model.getPlayer() + " succeeded in leaving jail! Your token will be moved!");
	}
